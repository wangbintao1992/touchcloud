...
<body>
	<div class="container b">
		...
		<div class="row" id="dArr">
			...
			<dir class="d col-md-6" id="h3">

			</dir>
			<dir class="d col-md-6" id="h4">

			</dir>
			<dir class="d col-md-6" id="h5">

			</dir>
			<dir class="d col-md-6" id="h6">
	            ...
	            chart: {
	                ...
	                events: {
	                    load: function () {
	                        ...
	                        var series = this.series[0];
	                        setInterval(function () {
	                           $.get("/TouchCloud/getChartData?sensorId=" + tmpSensorArr[2],function(data){
	                        	    //var x = Date.parse(new Date(data.time));
	                        	    //x = x / 1000;
	                   				var x = (new Date()).getTime();
	                        	    var y = parseInt(data.value);
	            ...
	            chart: {
	                ...
	                events: {
	                    load: function () {
	                        ...
	                        var series = this.series[0];
	                        setInterval(function () {
	                           $.get("/TouchCloud/getChartData?sensorId=" + tmpSensorArr[3],function(data){
	                        	    //var x = Date.parse(new Date(data.time));
	                        	    //x = x / 1000;
	                   				var x = (new Date()).getTime();
	                        	    var y = parseInt(data.value);
	            ...
	            chart: {
	                ...
	                events: {
	                    load: function () {
	                        ...
	                        var series = this.series[0];
	                        setInterval(function () {
	                           $.get("/TouchCloud/getChartData?sensorId=" + tmpSensorArr[4],function(data){
	                        	    //var x = Date.parse(new Date(data.time));
	                        	    //x = x / 1000;
	                   				var x = (new Date()).getTime();
	                        	    var y = parseInt(data.value);
	            ...
	            chart: {
	                ...
	                events: {
	                    load: function () {
	                        ...
	                        var series = this.series[0];
	                        setInterval(function () {
	                           $.get("/TouchCloud/getChartData?sensorId=" + tmpSensorArr[5],function(data){
	                        	    //var x = Date.parse(new Date(data.time));
	                        	    //x = x / 1000;
	                   				var x = (new Date()).getTime();
	                        	    var y = parseInt(data.value);
